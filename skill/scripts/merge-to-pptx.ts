/**
 * @deprecated Use editable PPTX from skilldeck: `python -m editable_pptx <slide-deck-dir>`
 * (MinerU layout + native text). This script embeds one flat image per slide only.
 */
